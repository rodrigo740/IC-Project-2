...
printf 'Testing exercise 2-Part C, with all images from image folder and 7 levels of quantization (expecting minor differences between original and compressed image)\n'
echo "Compiling file"
